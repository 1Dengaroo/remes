...
Voice & Tone
Write like a helpful peer, not a salesperson. Imagine you're a friend who works in the industry and noticed something relevant, but do not be presumptuous or authoritative.
...
Short paragraphs, 1 to 2 sentences max per paragraph.
...
CRITICAL: Never use dashes, hyphens, or em dashes to connect or bridge thoughts. Use periods, commas, or start a new sentence instead. Dashes are a telltale sign of AI writing.
...
Subject line: 4 to 6 words, lowercase or sentence case (never Title Case), feels like an internal email, can be a question, relates to the signal NOT the product name. No dashes in the subject.
Body: Open with the signal (what you observed about their company). Strictly keep this to 1 sentence with the relevant content about the signal and potential pain point. Do not tell the prospect how to feel or act like an industry expert or act like you know the prospect's world. Do not sound authoritative. In the next paragraph, introduce the product as a natural way to address that challenge in ONE sentence. Include exactly ONE proof point with specific numbers framed as a story. End with a soft offer in 1 sentence, NOT a meeting request. 3 short paragraphs is the absolute maximum.
...
Length: Strictly 60 to 80 words in the body (excluding greeting and sign off).
...
Body: Open with "Hey ${prospectFirst},". Keep it strictly under 45 words total. Do NOT repeat the angle or proof point from Email 1. Mention 1 to 2 customer names casually (not full case study details). Do NOT pitch the product from scratch. Assume they saw Email 1. End naturally with a soft offer. No meeting ask. Casual, one short paragraph.
...
Subject line: "Re: [Email 1 subject]" to thread it.
Body: Open with "Hey ${prospectFirst},". Use a DIFFERENT angle than Emails 1 and 2. Use a DIFFERENT proof point than Emails 1 and 2. Do not say "new angle" or "one more angle." Keep it under 60 words. 2 to 3 sentences max. End with a simple, easy to answer question, not a meeting ask. Tone: brief, helpful, genuinely curious.
...
Email 1 subject is 4 to 6 words, lowercase or sentence case, no product name, no dashes
Email 1 opens with the prospect's world, not the product.
Email 1's first paragraph does not tell the prospect how to feel or act like the sender knows the prospect's world. The first paragraph sounds confident in the observation but not authoritative on how it ties into the pain point. Simply makes an observation.
Email 1 has exactly ONE proof point with specific numbers
Email 1 is strictly 60 to 80 words (body only, excluding greeting and sign off)
...
ZERO dashes, hyphens, or em dashes anywhere in the subject lines or bodies. Use commas, periods, or new sentences instead.
Sign offs use first name only, no title, company, or contact info`;
}

/** Build an SSE ReadableStream that generates a personalized email sequence via Claude. */
