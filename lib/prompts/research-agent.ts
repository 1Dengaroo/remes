...
Rules: Only use URLs from search results (null if not found). Only real full names for contacts (no placeholders). Infer emails from domain pattern. For linkedin_url, use the exact URL you found in search results (e.g. https://www.linkedin.com/company/stripe) — do NOT guess or construct it.`;
}
