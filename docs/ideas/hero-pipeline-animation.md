...
## Problem Statement
How might we show SMB founders what Remes does *instantly* — without requiring them to scroll or interact — through a right-side hero animation that demonstrates the signal-to-email pipeline?
